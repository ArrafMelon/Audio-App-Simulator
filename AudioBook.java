...
public class AudioBook extends AudioContent
{
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	public void printInfo()
	{
		...
		super.printInfo();
		// Add on to existing information with info about the Audio book
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		// sets audio file to the title of current chapter and the chapter
	...
	{
		//loop through array list and print out each title of the chapters (we print i+1 because)
		// we cannot start at a chapter 0
	...
	{
		// checks if other is in audiobook class
		if(other instanceof AudioBook)
		{
			//create new audiobook variable and compare the values, return true if all equals
			AudioBook newBook = (AudioBook) other;
			return(super.equals(newBook) && this.author.equals(newBook.author) && this.narrator.equals(newBook.narrator));
		}
		return false;
	}
